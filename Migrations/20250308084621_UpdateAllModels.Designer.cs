...
namespace Bangazon.Migrations
{
    ...
    [Migration("20250308084621_UpdateAllModels")]
            ...
            modelBuilder.Entity("Bangazon.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            UserId = "yZ123AbC456DeFgHijKlmN789Opq"
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("Bangazon.Models.PaymentType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            CustomerId = "yZ123AbC456DeFgHijKlmN789Opq",
                            Type = "PayPal"
                        });
                });
            ...
            modelBuilder.Entity("Bangazon.Models.Seller", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            SellerId = "yZ123AbC456DeFgHijKlmN789Opq",
                            StoreId = 1
                        });
                });
            ...
            modelBuilder.Entity("Bangazon.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsSeller = true,
                            LastName = "Foster",
                            Uid = "yZ123AbC456DeFgHijKlmN789Opq",
                            Zip = 37209
                        },
                        new
                        {
